...
Route::get('/', [App\Http\Controllers\Inicio::class, 'Inicio'])->name('inicial');
...
Route::get('/detalhes', [App\Http\Controllers\DetalhesAnimal::class, 'detalhesAnimal'])->name('registro');
