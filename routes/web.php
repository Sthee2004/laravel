...
Route::get('/listar-animais', [App\Http\Controllers\ListarAnimais::class, 'listar-animais'])->name('listar-animal');
Route::get('/login', [App\Http\Controllers\Login::class, 'login'])->name('login');
Route::get('/registro', [App\Http\Controllers\registro::class, 'registro'])->name('resgistro');
